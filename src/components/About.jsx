    ...
    useGSAP(() => {
        ...
        scrollTimeline
            ...
            .from('.top-grid div, .bottom-grid div', {
                ...
                ease: 'power1.out',
                stagger: 0.04,
            }, '-=0.05')    //Sets the animation to take place 1/2 a second after the previous one kinda similar to adding an empty array [] for setting the ting to work only at the initial loading
    })
